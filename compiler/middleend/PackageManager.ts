...
export const PACKAGE_UNINSTALL_ROOT_SYMLINK_CODE =
  "BPL_PACKAGE_UNINSTALL_ROOT_SYMLINK";
export const PACKAGE_UNINSTALL_ROOT_NOT_DIRECTORY_CODE =
  "BPL_PACKAGE_UNINSTALL_ROOT_NOT_DIRECTORY";
export const PACKAGE_UNINSTALL_MANIFEST_MISSING_CODE =
  "BPL_PACKAGE_UNINSTALL_MANIFEST_MISSING";
export const PACKAGE_UNINSTALL_JSON_ERROR_CODES = [
  PACKAGE_UNINSTALL_NAME_INVALID_CODE,
  PACKAGE_UNINSTALL_NOT_INSTALLED_CODE,
  PACKAGE_UNINSTALL_ROOT_SYMLINK_CODE,
  PACKAGE_UNINSTALL_ROOT_NOT_DIRECTORY_CODE,
  PACKAGE_UNINSTALL_MANIFEST_MISSING_CODE,
] as const;
