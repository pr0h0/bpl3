export const TIMEOUT_ENV_DEFAULTS = {
  ...
  SANITIZER_RUNTIME_TEST_TIMEOUT_MS: 30000,
} as const;
...
const TIMEOUT_ENV_CONFIGS: TimeoutEnvConfig[] = [
  ...
  {
    name: "SANITIZER_RUNTIME_TEST_TIMEOUT_MS",
    defaultMs: TIMEOUT_ENV_DEFAULTS.SANITIZER_RUNTIME_TEST_TIMEOUT_MS,
    fallbackAction: `using ${TIMEOUT_ENV_DEFAULTS.SANITIZER_RUNTIME_TEST_TIMEOUT_MS}ms`,
  },
];
