...
function peg$parse(input, options) {
  ...
  function peg$f11(name, type) {    return { name, type };  }
  function peg$f12(name) {    return { name };  }
  function peg$f13(targets) {    return targets;  }
  ...
  function peg$f16(attrs, name, gen, params, ret, body) {
  ...
  function peg$f17(name, gen, inheritance, members) {
    const genericParams = gen ? gen : [];
  ...
  function peg$f18(name, gen, ext, content) {
    const genericParams = gen ? gen : [];
  ...
  function peg$f19(variants, methods) {
    return { variants, methods: methods || [] };
  }
  function peg$f20(methods) {
  ...
  function peg$f30(name, gen, params, ret) {
    const genericParams = gen ? gen : [];
    const paramList = params ? params : [];
  ...
  function peg$f32(fd) {    return fd;  }
  function peg$f33(name, type) {    return { kind: "StructField", name, type, location: location() };  }
  function peg$f34(name, type) {    return { kind: "StructField", name, type, location: location() };  }
  function peg$f35(name, gen, type) {
    const genericParams = gen ? gen : [];
    return typeAlias(name, genericParams, type, location());
  }
  function peg$f36(items, src) {
  ...
  function peg$f37(ns, src) {
    return importStmt([], src.value, true, ns, location());
  }
  function peg$f38(src) {    return importStmt([], src.value, true, undefined, location());  }
  function peg$f39(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f40(name) {    return { name, isType: true, isWrapped: false };  }
  function peg$f41(name) {    return { name, isType: false, isWrapped: true };  }
  function peg$f42(name, alias) {
    return { name, alias: alias ? alias[3] : undefined, isType: false, isWrapped: false };
  }
  function peg$f43(item) {
    return exportStmt([item], location());
  }
  function peg$f44(name) {    return { name, isType: true, isWrapped: false };  }
  function peg$f45(name) {    return { name, isType: false, isWrapped: true };  }
  function peg$f46(name) {    return { name, isType: false, isWrapped: false };  }
  function peg$f47(name, params, ret) {
  ...
  function peg$f48() {    return { params: [], isVariadic: true };  }
  function peg$f49(first, tail, variadic) {
    const params = [first, ...tail.map(t => t[3])];
    return { params, isVariadic: !!variadic };
  }
  function peg$f50(s) {    return s.value;  }
  function peg$f51(flavor, content, clobbers) {
  ...
  function peg$f54(p) {    return p;  }
  function peg$f55(parts) {    return parts.join("");  }
  ...
  function peg$f61(body) {    return "{" + body + "}";  }
  function peg$f62(s) {    return s;  }
  function peg$f63(header, body) {
    const { init, cond, step, isCStyle } = header || {};
    if (!body) return null;
    return loopStmt(init, cond, step, body, location(), isCStyle);
  }
  function peg$f64(init, cond, step) {
    return { init, cond, step, isCStyle: true };
  }
  function peg$f65(cond) {
    return { cond, isCStyle: false };
  }
  function peg$f66() {    return undefined;  }
  function peg$f67(cond, thenBranch, elseBranch) {
    if (!thenBranch) return null;
    return ifStmt(cond, thenBranch, elseBranch || undefined, location());
  }
  function peg$f68(stmt) {    return stmt;  }
  function peg$f69(expr) {    return returnStmt(expr || undefined, location());  }
  function peg$f70() {    return breakStmt(location());  }
  function peg$f71() {    return continueStmt(location());  }
  function peg$f72(stmt) {    return { kind: "Defer", statement: stmt, location: location() };  }
  function peg$f73(tryBlock, catches) {
    const catchList = catches.map(c => c[0]);
    return tryStmt(tryBlock, catchList, location());
  }
  function peg$f74(name, type, body) {
    return catchClause(name, type, body, location());
  }
  function peg$f75(body) {
    // Catch-all: no variable, no type
    return catchClause(null, null, body, location());
  }
  function peg$f76(expr) {    return throwStmt(expr, location());  }
  function peg$f77() {    return { kind: "Fallthrough", location: location() };  }
  function peg$f78(expr, cases, defaultCase) {
  ...
  function peg$f81(block) {    return [block];  }
  function peg$f82(stmt) {    return stmt;  }
  function peg$f83(stmts) {    return stmts;  }
  function peg$f84() {    return [];  }
  function peg$f85(stmts) {
    // Filter out null values from error recovery
    const filtered = stmts.filter(s => s !== null);
    let body;
    if (filtered.length === 1 && filtered[0].kind === "Block") {
  ...
  function peg$f86(expr, semi) {    return semi || expr.kind === "Match";  }
  ...
  function peg$f89(op) {    return { op, pos: offset() };  }
  function peg$f90(cond, trueExpr, falseExpr) {
    return ternary(cond, trueExpr, falseExpr, mergeLoc(cond.location, falseExpr.location));
  }
  function peg$f91(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f92(op) {    return { op, pos: offset() };  }
  function peg$f93(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f94(op) {    return { op, pos: offset() };  }
  function peg$f95(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f96(op) {    return { op, pos: offset() };  }
  function peg$f97(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f98(op) {    return { op, pos: offset() };  }
  function peg$f99(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f100(op) {    return { op, pos: offset() };  }
  function peg$f101(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f102(op) {    return { op, pos: offset() };  }
  function peg$f103(head, tail) {
    return foldTypeCheckTail(head, tail);
  }
  function peg$f104(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f105(op) {    return { op, pos: offset() };  }
  function peg$f106(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f107(op) {    return { op, pos: offset() };  }
  function peg$f108(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f109(op) {    return { op, pos: offset() };  }
  function peg$f110(left, tail) {
    return foldBinaryTail(left, tail);
  }
  function peg$f111(op) {    return { op, pos: offset() };  }
  function peg$f112(op, expr) {
    const opToken = makeOperatorTokenFromPos(op.op, op.pos, op.type);
    return unary(opToken, expr, true, location());
  }
  function peg$f113(op) {    return { op, pos: offset() };  }
  function peg$f114(primary, postfixes) {
    let expr = primary;
  ...
  function peg$f127(type, expr) {
    return castNode(type, expr, location());
  }
  function peg$f128(type) {    return sizeofNode(type, location());  }
  function peg$f129(arg) {    return sizeofNode(arg, location());  }
  function peg$f130(expr) {    return sizeofNode(expr, location());  }
  function peg$f131(type) {    return typeOfNode(type, location());  }
  function peg$f132(arg) {    return typeOfNode(arg, location());  }
  function peg$f133(type, member) {    return offsetofNode(type, member, location());  }
  function peg$f134(type, val) {    return matchNode(type, val, location());  }
  function peg$f135(value, arms) {
    return matchExpr(value, arms || [], location());
  }
  function peg$f136(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f137(pattern, guard, body) {
    const guardExpr = guard ? guard[3] : undefined;
    return matchArm(pattern, guardExpr, body, location());
  }
  function peg$f138() {    return patternWildcard(location());  }
  function peg$f139(patterns) {
    return patternTuple(patterns, location());
  }
  function peg$f140(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f141(retType, body) {
    return lambdaExpression([], retType ? retType[2] : null, body, location());
  }
  function peg$f142(params, retType, body) {
    return lambdaExpression(params || [], retType ? retType[2] : null, body, location());
  }
  function peg$f143(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f144(name, type) {
    return { name, type: type ? type[2] : null, location: location() };
  }
  function peg$f145(expr) {
  ...
  function peg$f146(lit) {
         return patternLiteral(lit, location());
  }
  function peg$f147(name) {    return patternIdentifier(name, location());  }
  function peg$f148(name, gen) {
    return { name: name, genericArgs: gen || [] };
  }
  function peg$f149(enumName, rest) {
  ...
  function peg$f151(enumName, rest, bindings) {
    let name = enumName.name;
    let generics = enumName.genericArgs;
    let variant = "";
  ...
  function peg$f152(enumName, rest, fields) {
    let name = enumName.name;
    let generics = enumName.genericArgs;
    let variant = "";
  ...
  function peg$f153(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f154(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f155(fieldName, binding) {
    return { fieldName, binding };
  }
  function peg$f156(elems) {
    return arrayLiteral(elems || [], location());
  }
  function peg$f157(head, tail) {    return [head, ...tail.map(t => t[3])];  }
  function peg$f158(name, gen, fields) {
    return structLiteral(name, fields || [], location(), gen || []);
  }
  function peg$f159(head, tail) {
    return collectTailIndex(head, tail, 3);
  }
  function peg$f160(key, value) {    return { name: key, value };  }
  ...
  function peg$f166(raw) {    return literal(parseNumber(raw), raw, "number", location());  }
  function peg$f167(raw) {
  ...
  function peg$f170(isConstPrefix, isVariadicPrefix, name, isConstType, isVariadicSuffix, type) {
  ...
  function peg$f172(name, constraint) {
    return { name, constraint: constraint ? constraint[3] : undefined };
  }
  function peg$f173(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f174(type) {    return { returnType: type };  }
  function peg$f175(isConst, t) {
    if (isConst) {
      t.isConst = true;
    }
    return t;
  }
  function peg$f176(t, arr) {
    if (arr.length > 0) {
  ...
  function peg$f177(ret, params, arr) {
  ...
  function peg$f179(head, tail) {    return [head, ...tail.map(t => t[3])];  }
  function peg$f180(head, tail, arr) {
    const types = [head, ...tail.map(t => t[3])];
    const t = tupleType(types, location());
    t.arrayDimensions = arr.length ? arr.map(a => a) : [];
    return t;
  }
  function peg$f181(ptrs, name, gen, arr) {
  ...
  function peg$f182() {    return "Self";  }
  function peg$f183(head, tail) {    return [head, ...tail.map(t => t[3])].join(".");  }
  function peg$f184(sign, size) {    return sign ? -size.value : size.value;  }
  function peg$f185() {    return null;  }
  function peg$f186(c) {
  ...
  function peg$f188(expr) {    return expr;  }
  function peg$f189(chars) {
  ...
  function peg$parseTopLevelErrorRecovery() {
    ...
    if (s1 !== peg$FAILED) {
      if (input.length > peg$currPos) {
        ...
        s2 = peg$FAILED;
        if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e0); }
      }
      if (s2 !== peg$FAILED) {
        peg$savedPos = s0;
        s0 = peg$f1(s2);
  ...
  function peg$parseErrorRecovery() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (input.charCodeAt(peg$currPos) === 125) {
        ...
        s3 = peg$FAILED;
        if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e1); }
      }
      peg$silentFails--;
      if (s3 === peg$FAILED) {
        s2 = undefined;
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          ...
          if (peg$r0.test(s7)) {
            ...
            s7 = peg$FAILED;
            if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e2); }
          }
          peg$silentFails--;
          if (s7 === peg$FAILED) {
            s6 = undefined;
          ...
          if (input.charCodeAt(peg$currPos) === 59) {
            ...
            s5 = peg$FAILED;
            if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e3); }
          }
          if (s5 === peg$FAILED) {
            s5 = null;
          }
    ...
    if (s1 !== peg$FAILED) {
          ...
          if (s8 !== peg$FAILED) {
            ...
            if (s10 !== peg$FAILED) {
              ...
              if (input.charCodeAt(peg$currPos) === 61) {
                ...
                s12 = peg$FAILED;
                if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e5); }
              }
              if (s12 !== peg$FAILED) {
                s13 = peg$parse_();
      ...
      if (s3 === peg$FAILED) {
        ...
        if (input.charCodeAt(peg$currPos) === 40) {
          ...
          s4 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e6); }
        }
        if (s4 !== peg$FAILED) {
          s5 = peg$parse_();
          s6 = peg$parseDestructTargetList();
          if (s6 !== peg$FAILED) {
            s7 = peg$parse_();
            if (input.charCodeAt(peg$currPos) === 41) {
              ...
              s8 = peg$FAILED;
              if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e7); }
            }
            if (s8 !== peg$FAILED) {
              s9 = peg$parse_();
              if (input.charCodeAt(peg$currPos) === 61) {
  ...
  function peg$parseDestructTargetList() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (input.charCodeAt(peg$currPos) === 44) {
        ...
        s5 = peg$FAILED;
        if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e8); }
      }
      if (s5 !== peg$FAILED) {
        s6 = peg$parse_();
  ...
  function peg$parseAttributeList() {
    ...
    if (input.startsWith(peg$c7, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e9); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (input.charCodeAt(peg$currPos) === 93) {
          ...
          s8 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e10); }
        }
        if (s8 !== peg$FAILED) {
          peg$savedPos = s0;
          s0 = peg$f14(s3, s4);
      ...
      if (s4 !== peg$FAILED) {
        ...
        if (s8 !== peg$FAILED) {
          ...
          if (s12 !== peg$FAILED) {
            ...
            if (s16 !== peg$FAILED) {
              peg$savedPos = s0;
              s0 = peg$f16(s1, s4, s6, s10, s14, s16);
            } else {
              peg$currPos = s0;
              s0 = peg$FAILED;
            }
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (input.charCodeAt(peg$currPos) === 123) {
          ...
          s9 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e11); }
        }
        if (s9 !== peg$FAILED) {
          s10 = peg$parse_();
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (input.charCodeAt(peg$currPos) === 42) {
          ...
          s3 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e12); }
        }
        if (s3 !== peg$FAILED) {
          s4 = peg$parse_();
          s5 = peg$parseK_as();
  ...
  function peg$parseImportItem() {
    ...
    if (input.charCodeAt(peg$currPos) === 91) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e13); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      s3 = peg$parseIdentifier();
  ...
  function peg$parseExternParameterList() {
    ...
    if (input.startsWith(peg$c12, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e14); }
    }
    if (s1 !== peg$FAILED) {
      peg$savedPos = s0;
      s1 = peg$f48();
  ...
  function peg$parseAsmString() {
    ...
    if (input.charCodeAt(peg$currPos) === 34) {
      ...
      s3 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e15); }
    }
    if (s3 !== peg$FAILED) {
      s4 = [];
      s5 = peg$currPos;
      if (input.charCodeAt(peg$currPos) === 92) {
        ...
        s6 = peg$FAILED;
        if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e16); }
      }
      if (s6 !== peg$FAILED) {
        if (input.length > peg$currPos) {
          s7 = input.charAt(peg$currPos);
      ...
      if (s5 === peg$FAILED) {
        ...
        if (peg$r1.test(s5)) {
          ...
          s5 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e17); }
        }
      }
      while (s5 !== peg$FAILED) {
        s4.push(s5);
  ...
  function peg$parseAsmCharLiteral() {
    ...
    if (input.charCodeAt(peg$currPos) === 39) {
      ...
      s3 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e18); }
    }
    if (s3 !== peg$FAILED) {
      s4 = peg$currPos;
      if (input.charCodeAt(peg$currPos) === 92) {
      ...
      if (s4 === peg$FAILED) {
        ...
        if (peg$r2.test(s4)) {
          ...
          s4 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e19); }
        }
      }
      if (s4 !== peg$FAILED) {
        if (input.charCodeAt(peg$currPos) === 39) {
  ...
  function peg$parseAsmComment() {
    ...
    if (input.charCodeAt(peg$currPos) === 35) {
      ...
      s3 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e20); }
    }
    if (s3 !== peg$FAILED) {
      s4 = [];
      s5 = input.charAt(peg$currPos);
      if (peg$r3.test(s5)) {
        ...
        s5 = peg$FAILED;
        if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e21); }
      }
      while (s5 !== peg$FAILED) {
        s4.push(s5);
        s5 = input.charAt(peg$currPos);
  ...
  function peg$parseAsmText() {
    ...
    if (peg$r4.test(s3)) {
      ...
      s3 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e22); }
    }
    if (s3 !== peg$FAILED) {
      while (s3 !== peg$FAILED) {
        s2.push(s3);
  ...
  function peg$parseTernary() {
    ...
    return peg$f90(condition, trueExpr, falseExpr);
  }
  ...
  function peg$parsePostfix() {
    ...
    if (
      ...
      if (directMemberProperty !== peg$FAILED) {
        ...
        if (input.charCodeAt(directMemberLookaheadPos) !== 123) {
          ...
          peg$savedPos = startPos;
          return peg$f114(directMember, postfixes);
        }
      }
    ...
    peg$savedPos = startPos;
    return peg$f114(primary, postfixes);
  }
  ...
  function peg$parsePostfixTailAfterTrivia() {
    ...
    if (input.charCodeAt(peg$currPos) === 60) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e70); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (input.charCodeAt(peg$currPos) === 62) {
          ...
          s5 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e71); }
        }
        if (s5 !== peg$FAILED) {
          peg$savedPos = s0;
          s0 = peg$f116(s3);
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          ...
          if (input.charCodeAt(peg$currPos) === 46) {
            ...
            s1 = peg$FAILED;
            if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e72); }
          }
          if (s1 !== peg$FAILED) {
            s2 = peg$parse_();
            s3 = peg$parseIdentifier();
            ...
            if (s0 === peg$FAILED) {
              ...
              if (s1 !== peg$FAILED) {
                ...
                if (peg$r9.test(s4)) {
                  ...
                  s4 = peg$FAILED;
                  if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e73); }
                }
                if (s4 !== peg$FAILED) {
                  while (s4 !== peg$FAILED) {
                    s3.push(s4);
              ...
              if (s0 === peg$FAILED) {
                ...
                if (input.startsWith(peg$c58, peg$currPos)) {
                  ...
                  s1 = peg$FAILED;
                  if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e67); }
                }
                if (s1 === peg$FAILED) {
                  if (input.startsWith(peg$c59, peg$currPos)) {
                    ...
                    s1 = peg$FAILED;
                    if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e68); }
                  }
                }
                if (s1 !== peg$FAILED) {
                  peg$savedPos = s0;
  ...
  function peg$parseMatchArm() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (input.startsWith(peg$c63, peg$currPos)) {
        ...
        s5 = peg$FAILED;
        if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e74); }
      }
      if (s5 !== peg$FAILED) {
        s6 = peg$parse_();
  ...
  function peg$parsePatternWildcard() {
    ...
    if (input.charCodeAt(peg$currPos) === 95) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e75); }
    }
    if (s1 !== peg$FAILED) {
      peg$savedPos = s0;
      s1 = peg$f138();
  ...
  function peg$parseLambdaExpression() {
    ...
    if (input.charCodeAt(peg$currPos) === 124) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e55); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      s3 = peg$parseK_void();
      if (s3 !== peg$FAILED) {
        ...
        if (s5 !== peg$FAILED) {
          ...
          if (input.startsWith(peg$c65, peg$currPos)) {
            ...
            s8 = peg$FAILED;
            if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e76); }
          }
          if (s8 !== peg$FAILED) {
            s9 = peg$parse_();
            s10 = peg$parseType();
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (peg$r10.test(s7)) {
          ...
          s7 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e77); }
        }
        if (s7 !== peg$FAILED) {
          s6 = [s6, s7];
          s5 = s6;
  ...
  function peg$parseParameter() {
    ...
    if (s5 !== peg$FAILED) {
      ...
      if (s7 !== peg$FAILED) {
        ...
        peg$savedPos = s0;
        s0 = peg$f170(s1, s3, s5, s9, s11, s13);
      } else {
        peg$currPos = s0;
        s0 = peg$FAILED;
      }
  ...
  function peg$parseSelfKeyword() {
    ...
    if (input.startsWith(peg$c72, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e89); }
    }
    if (s1 !== peg$FAILED) {
  ...
  function peg$parseArraySuffix() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (input.charCodeAt(peg$currPos) === 45) {
        ...
        s3 = peg$FAILED;
        if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e90); }
      }
      if (s3 === peg$FAILED) {
        s3 = null;
      }
  ...
  function peg$parseK_const() {
    ...
    if (input.startsWith(peg$c74, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e91); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_type() {
    ...
    if (input.startsWith(peg$c19, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e25); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_struct() {
    ...
    if (input.startsWith(peg$c21, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e27); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_enum() {
    ...
    if (input.startsWith(peg$c22, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e28); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_spec() {
    ...
    if (input.startsWith(peg$c23, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e29); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_import() {
    ...
    if (input.startsWith(peg$c24, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e30); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_from() {
    ...
    if (input.startsWith(peg$c75, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e92); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_as() {
    ...
    if (input.startsWith(peg$c76, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e93); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_export() {
    ...
    if (input.startsWith(peg$c25, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e31); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_extern() {
    ...
    if (input.startsWith(peg$c26, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e32); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_asm() {
    ...
    if (input.startsWith(peg$c27, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e33); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_loop() {
    ...
    if (input.startsWith(peg$c28, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e34); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_if() {
    ...
    if (input.startsWith(peg$c29, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e35); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_else() {
    ...
    if (input.startsWith(peg$c77, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e94); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_break() {
    ...
    if (input.startsWith(peg$c30, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e36); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_continue() {
    ...
    if (input.startsWith(peg$c31, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e37); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_defer() {
    ...
    if (input.startsWith(peg$c32, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e38); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_try() {
    ...
    if (input.startsWith(peg$c33, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e39); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_catch() {
    ...
    if (input.startsWith(peg$c78, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e95); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_return() {
    ...
    if (input.startsWith(peg$c34, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e40); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_throw() {
    ...
    if (input.startsWith(peg$c35, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e41); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_switch() {
    ...
    if (input.startsWith(peg$c36, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e42); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_case() {
    ...
    if (input.startsWith(peg$c79, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e96); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_default() {
    ...
    if (input.startsWith(peg$c80, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e97); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_fallthrough() {
    ...
    if (input.startsWith(peg$c37, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e43); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_cast() {
    ...
    if (input.startsWith(peg$c81, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e98); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_sizeof() {
    ...
    if (input.startsWith(peg$c82, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e99); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_typeof() {
    ...
    if (input.startsWith(peg$c83, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e100); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_offsetof() {
    ...
    if (input.startsWith(peg$c84, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e101); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_match() {
    ...
    if (input.startsWith(peg$c85, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e102); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_is() {
    ...
    if (input.startsWith(peg$c86, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e103); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_Func() {
    ...
    if (input.startsWith(peg$c87, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e104); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_Lambda() {
    ...
    if (input.startsWith(peg$c88, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e105); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_void() {
    ...
    if (input.startsWith(peg$c89, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e106); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_true() {
    ...
    if (input.startsWith(peg$c90, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e107); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_false() {
    ...
    if (input.startsWith(peg$c91, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e108); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_null() {
    ...
    if (input.startsWith(peg$c92, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e109); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseK_nullptr() {
    ...
    if (input.startsWith(peg$c93, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e110); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parseIdBoundary();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseWhitespace() {
    ...
    if (peg$r16.test(s1)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e112); }
    }
    if (s1 !== peg$FAILED) {
      while (s1 !== peg$FAILED) {
        s0.push(s1);
  ...
  function peg$parseMultiLineComment() {
    ...
    if (input.startsWith(peg$c95, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e113); }
    }
    if (s1 !== peg$FAILED) {
      s2 = [];
      ...
      if (s3 === peg$FAILED) {
        ...
        if (input.startsWith(peg$c96, peg$currPos)) {
          ...
          s5 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e114); }
        }
        peg$silentFails--;
        if (s5 === peg$FAILED) {
          s4 = undefined;
  ...
  function peg$parseInterpolatedStringLiteral() {
    ...
    if (input.charCodeAt(peg$currPos) === 96) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e115); }
    }
    if (s1 !== peg$FAILED) {
      s2 = [];
  ...
  function peg$parseInterpolatedStringPart() {
    ...
    if (input.startsWith(peg$c98, peg$currPos)) {
      ...
      s1 = peg$FAILED;
      if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e116); }
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      s3 = peg$parseAssignment();
  ...
  function peg$parseInterpolatedStringChar() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (peg$r17.test(s1)) {
        ...
        s1 = peg$FAILED;
        if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e117); }
      }
      if (s1 !== peg$FAILED) {
        peg$savedPos = s0;
        s1 = peg$f192(s1);
      ...
      if (s0 === peg$FAILED) {
        ...
        if (input.charCodeAt(peg$currPos) === 36) {
          ...
          s1 = peg$FAILED;
          if (peg$collectExpected && peg$silentFails === 0) { peg$fail(peg$e118); }
        }
        if (s1 !== peg$FAILED) {
          s2 = peg$currPos;
          peg$silentFails++;
