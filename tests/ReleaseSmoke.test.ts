...
describe("Release smoke", () => {
  ...
  test(
    ...
    () => {
      ...
      expect(result.stdout).toContain(
        "release smoke: check packed npm CLI package pack JSON",
      );
      expect(result.stdout).toContain(
        "release smoke: check packed npm CLI package init JSON",
      );
      expect(result.stdout).toContain(
        "release smoke: check packed npm CLI bpl new JSON",
      );
      expect(result.stdout).toContain(
        "release smoke: check packed npm CLI package uninstall JSON",
      );
      expect(result.stdout).toContain(
      ...
      expect(result.stdout).toContain(
        "release smoke: check packed npm CLI global package list JSON",
      );
      expect(result.stdout).toContain(
      ...
      expect(result.stdout).toContain(
        "release smoke: check packed npm CLI build validation JSON",
      );
      expect(result.stdout).toContain(
        "release smoke: check packed npm CLI clean validation JSON",
      );
      expect(result.stdout).toContain(
      ...
      expect(result.stdout).toContain(
        "release smoke: check packed npm CLI CI triage stale lock JSON",
      );
      expect(result.stdout).toContain(
