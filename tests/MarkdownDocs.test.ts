...
describe("Markdown documentation", () => {
  ...
  test("package docs document import safety rules", () => {
    ...
    const requiredSnippets = [
      ...
      "`repository` must contain `type: \"git\"` and a string `url`",
      "The package import resolver also rejects malformed string metadata",
      "It also validates `keywords` as an array of strings and `repository` as an object with `type: \"git\"` and a string `url`",
  ...
  test("package docs document install and archive JSON error codes", () => {
    ...
    const requiredSnippets = [
      ...
      "unsafe untracked package roots",
      "`packageName`",
      "`expectedHash`",
      "`actualHash`",
      "`dependencyOf`",
  ...
  test("playground docs document native execution payload contract", () => {
    ...
    const requiredSnippets = [
      ...
      "`execute: false`",
      "The default Run Code request omits IR, AST, and token payloads",
      "Debug tabs load artifacts lazily",
