/**
 * Clean Command Action
 * Removes build artifacts and caches after command dispatch.
 */
...
export function runCleanCommand(
  ...
  try {
    ...
    const report: CleanReport = createJsonReport(CLI_JSON_CHECKS.clean, true, {
