...
`;
        ...
        writeFileAtomically(path.join(stagingPath, "main.bpl"), mainContent);
        if (options.verbose) {
...
`;
      ...
      writeFileAtomically(path.join(stagingPath, "README.md"), readmeContent);
      if (options.verbose) {
