...
| BUG-056 | Enums               | Duplicate enum variants (e.g., `enum E { A, A }`) are accepted silently, creating ambiguity.                             | Open    | no same variant should exist,                                                                                                                                                                                                                                                            |
...
| BUG-059 | Types               | Compiler allows `void` as a named function argument type (e.g., `frame foo(v: void)`).                                   | Open    | no void should be allowed as arg or variable type, but allow \*void for pointers                                                                                                                                                                                                         |
| BUG-060 | Types               | Compiler allows arrays of `void` (e.g., `local arr: void[10]`), which is invalid as `void` has no size.                  | Open    | dont allow this, allow void only as \*void for pointers                                                                                                                                                                                                                                  |
...
| BUG-085 | Parser              | `sizeof(int[10])` fails parsing (interpreted as indexing expression).                                                    | Open    |                                                                                                                                                                                                                                                                                          |
...
| BUG-093 | Structs             | Struct fields of type `void` cause LLVM IR generation errors.                                                            | Open    | only \*void sohudl be allowed                                                                                                                                                                                                                                                            |
| BUG-094 | Generics            | Generic instantiation with `void` (e.g., `Box<void>`) causes LLVM IR generation errors.                                  | Open    | only Box<\*void> should work                                                                                                                                                                                                                                                             |
| BUG-095 | Generics            | Generic array of `void` (e.g., `Arr<void>`) causes LLVM IR generation errors.                                            | Open    | only Array<\*void> sohuld work                                                                                                                                                                                                                                                           |
| BUG-096 | Parser              | Parentheses in type declarations (e.g., `(*int)[10]`) are not supported.                                                 | Open    | this should be supported                                                                                                                                                                                                                                                                 |
| BUG-097 | Arrays              | Array of function types (e.g., `F[10]`) allocates single element instead of array.                                       | Open    | this should allocate array of function pointers or whatever, array                                                                                                                                                                                                                       |
| BUG-098 | Parser              | Array of tuples (e.g., `(int, int)[10]`) is a syntax error.                                                              | Open    | i guess we should support this, i think we need to upgrade our type recognition mechansam since we have a lot of problems with detecting generics, tuples, arrays, pointers and every type                                                                                               |
| BUG-099 | Generics            | Generic function type aliases fail substitution (generates invalid LLVM IR with `%struct.T`).                            | Open    |                                                                                                                                                                                                                                                                                          |
| BUG-100 | Generics            | Generic struct type aliases fail argument count check (e.g., `B<int>` where `B<T>=Box<T>` claims 2 args).                | Open    |                                                                                                                                                                                                                                                                                          |
